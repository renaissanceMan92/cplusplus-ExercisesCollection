...
int main() // main() ska ha int som return type, här hade den void.
{
	...
	double weeklyWages = hoursPerWeek * hourlyWages; // Datatypen var odefinierad. Valde double.
	...
	cout << " Given an hourly wage of " << hourlyWages << " kr" << endl
		...
		<< "the weekly wages will be: " << weeklyWages << " kr" << endl; // Uttrycket saknade ett semikolon.

	cout << "\nPress return!";
	cin.get(); // Wait for return

	return 0; // Här blev det syntax-error pga att main() hade return type void.
}
